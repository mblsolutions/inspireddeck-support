...
<body class="font-sans subpixel-antialiased bg-brand-gray-1000">
    ...
    <div class="w-10/12 lg:w-1/2 xl:w-1/3 mx-auto">

        <div class="flex items-center h-screen text-center">
            <div class="flex-1 text-brand-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-17.5 482.5 36 36" class="fill-current mx-auto w-20 h-20 mb-10">
