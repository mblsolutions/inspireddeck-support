...
Route::name('api.')->group(static function () {
    ...
    Route::post('report/manage/{report}/test', 'Report\ManageReportController@test')->name('report.manage.test');
    ...
    Route::post('report/{report}/print', 'Report\ReportController@print')->name('report.print');
